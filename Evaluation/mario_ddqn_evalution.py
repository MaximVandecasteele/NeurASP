...
def run(asp, pretrained):
    ...
    csv_file_path = f'data_generalization_neurasp_post_1e-05.csv'
    ...
    with open(csv_file_path, mode='a+', newline='') as file:
        ...
        for m in range(config['num_runs']):
            for e in range(1,11):
                pretrained_model_name = f'run_{m + 1}/neurasp_{e}_1e-05_model.pt'
                ...
                if use_tensorboard == True:
                    tensorboard_writer = SummaryWriter(f'training_run_neurasp_post/tensorboard_generalization/neurasp_post_generalization/run{m + 1}_1e-05_model{e}')
