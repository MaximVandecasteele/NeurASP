...
class NeurASP(object):
    def __init__(self, dprogram, nnMapping, optimizers, run, lr, gpu=False):
        ...
        with open('/Users/maximvandecasteele/PycharmProjects/NeurASP/Object_detector/data_neurasp/balanced_dataset/tensors_test.pkl',
                  'rb') as f:
    ...
    def learn(self, dataList, obsList, epoch, alpha=0, lossFunc='cross', method='exact', lr=0.01, opt=False, storeSM=False, smPickle=None, accEpoch=0, batchSize=1, bar=False):
        ...
        for epochIdx in range(epoch):
            ...
            for m in self.nnMapping:
                ...
                torch.save(model.state_dict(), f"/Users/maximvandecasteele/PycharmProjects/NeurASP/NeurASP/models/neurasp_post/run_{self.run}/neurasp_" + str(epochIdx + 1) + f"_{self.lr}_model.pt")
                ...
                self.write_to_csv(f'/Users/maximvandecasteele/PycharmProjects/NeurASP/NeurASP/models/neurasp_post/run_{self.run}/accuracy_curve.csv', [epochIdx, accuracy])
