...
evaluator.evaluate(num_episodes=1000, exp_name=exp_name, env=env, dqn=dqn, eval_path=eval_path)
...
BONJOUR MADAME, C'EST MOI, BABY JODY!
MAINTENANT, JE SUIS FINIS. MAINTENANT TU PEUX FAIRE CE QUE MONSIEUR A DIT.""")